    ...
    <div className="px-6 my-10">
      <form className="my-4" onSubmit={(e)=> e.preventDefault()}>
        <input
          ...
          value={textTyped}
        />
      <button onClick={()=>console.log(textTyped)} className="border border-gray-500 py-1 px-4 rounded-md bg-slate-200 ">submit</button>
      </form>
...
echo "# testing-github" >> README.md
git init
git add .
git commit -m "first commit"
git branch -M main
git remote add origin https://github.com/Jerryemmanuel01/testing-github.git
